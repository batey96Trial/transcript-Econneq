  ...
  return (
    <main className="p-5 space-y-8">
      ...
      <section className="flex flex-col">
        <h1 className="uppercase text text-center text-xl  font-open-sans text-red-500 font-bold">Higher National Diploma (HND)</h1>
      ...
      <footer>
        <p className="text-wrap max-w-4/5">Lorem ipsum dolor sit amet consectetur adipisicing elit.sciunt culpa iiae au voluptas numquam earumxime! Velit animi odit porro!</p>
